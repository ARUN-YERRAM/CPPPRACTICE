...
//  TIME COMPLEXITY: 
// for best case: o(n)......if elements are uniformly distributed in the range [0 to range]
//  for avg case: O(n+k).... where k is no of elements in .............each individual bucket.........
...
void bucketSort(float arr[], int size) {
    //  if elements are in range of ..............0 and 1...............
...
//   for in range ............0 and 1...........
    //  step2 inserting elements into bucket

    for (int i=0;i<size;i++){
        int index = arr[i]*size;    bucket[index].push_back(arr[i]);
    }

    // for elements not in range ..................0 and 1..........
    //  step2 inserting elements into bucket
    for (int i=0;i<size;i++){
...
//  SPACE COMPLEXITY: O(n+k(max_ele)).......  stable algorithm......... 
// 
// what are n and k
