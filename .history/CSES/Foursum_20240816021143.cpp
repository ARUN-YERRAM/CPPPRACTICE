        ...
        while(j<k){
            if((sum + vec[m] + vec[j] + vec[k]) == x){
                ...
                if((sum == vec[j]) && (sum == vec[k]) && sum == vec[m]){
                    ...
                    cout<<mp[vec[i]][0]<<" "<<mp[vec[j]][1]<<" "<<mp[vec[k]][2]<<" "<<mp[vec[m]][0]<<endl;
                    break;
                }else if((sum == vec[m]) && (sum == vec[k]) && sum!=vec[j]){
                    cout<<mp[vec[i]][0]<<" "<<mp[vec[m]][2]<<" "<<mp[vec[k]][1]<<" "<<mp[vec[j]][0]<<endl;
                    break;
                }
                else if((sum == vec[j]) && (sum != vec[k]) && sum!=vec[m]){
                    ...
                    cout<<mp[vec[i]][0]<<" "<<mp[vec[m]][1]<<" "<<mp[vec[k]][0]<<" "<<mp[vec[j]][0]<<endl;
                    break;
                }
                ...
                else if((vec[k] == vec[m]) && (sum != vec[k]) && vec[k]!=vec[j]){
                    cout<<mp[vec[k]][0]<<" "<<mp[vec[m]][1]<<" "<<mp[vec[i]][0]<<" "<<mp[vec[j]][0]<<endl;
                }
                else{
            ...
            else if((sum + vec[m] + vec[j] + vec[k]) < x){
                j++;
            }else k--;
