...
bool canDivide(const vector<long long int>& arr, long long int maxSum, long long int k) {
    int currentSum = 0;
...
long long int findMinimumMaxSubarraySum(const vector<long long int>& arr, long long int k) {
